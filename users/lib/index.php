...
<body>
  ...
  <div class="parts" id="parts_PRICE">
    <div class="section container align-center">
      ...
      <p>980円からというリーズナブルな価格でプロ並みのメルマガスタンドが使えます。<br />おためしパック「トライアルプラン」も新登場。</p>
      ...
      <div class="align-left">
        <small>
          ※1 ビギナーズ・スタンダード・パケット各プランをご利用の際には、<strong>クレジットカード登録</strong>が必須です。<br />
          ※2 登録リスト数が251件・1001件になると自動的にプランが「スタンダードプラン」及び「パケットプラン」に繰り上げられます。
        </small>
      </div>
    </div>
  </div>
