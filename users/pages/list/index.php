...
<body>
  ...
  <div class="content">
    <div class="section container">
      ...
      <h4 style="display:inline-block;margin-right:20px">読者一覧 (<?php echo stella_countlist($_COOKIE['userid']); ?>件)</h4><a href="http://entry.stella-mail.com/<?php echo $_COOKIE['userid'] ?>/" target="_blank"><i class="icon-user"></i> 読者登録</a>
