<?php
  $home_url = "http://transfer.stella-mail.com/";
  ...
  <div style="background:#ddd">
    <div class="section container">
      <ul id="menubar" class="col nine mobile-full">
        ...
        <li class="mobile-four"><a href="<?=$home_url; ?>payment/"><i class="icon-yen"></i> お支払い情報</a></li>
        <li class="no-tablet mobile-four"><a href="<?=$home_url; ?>?logout"><i class="icon-power-off"></i> ログアウト</a></li>
      </ul>
      <div class="col three no-mobile" id="menubarid"><i class="icon-user"></i> <?=$_COOKIE['userid']; ?></div>
      <div class="clearfix"></div>
    </div>
  </div>
