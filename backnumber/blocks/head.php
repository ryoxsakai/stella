...
<link rel="stylesheet" href="<?=$home_url; ?>users/lib/animate.css">
<link rel="stylesheet" href="<?=$home_url; ?>users/lib/jquery.powertip.css">
...
<script type="text/javascript" src="<?=$home_url; ?>users/lib/jquery.elastic.js"></script>
...
<script type="text/javascript" src="<?=$home_url; ?>users/lib/jquery.powertip.js"></script>
<script type="text/javascript" src="<?=$home_url; ?>users/lib/jquery.lettering.js"></script>
<script type="text/javascript" src="<?=$home_url; ?>users/lib/jquery.textillate.js"></script>
<script>
$(function(){
  $('h1').jrumble({
	speed: 100
