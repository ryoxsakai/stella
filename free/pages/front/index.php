  ...
  <div class="content">
    <div class="section container">
      ...
      <div class="multicolumn">
        <h3><i class="icon-info-sign"></i> お知らせ</h3>
        <?php require_once 'lib/tumblr.php' ?>
      </div>
      <div class="multicolumn">
        <h3><i class="icon-comment-alt"></i> 発行中のメルマガ</h3>
        <p><strong>メルマガの差出人</strong><br /><?=$magazineFrom; ?></p>
        <p><strong>メルマガのタイトル</strong><br /><?=$magazineTitle; ?></p>
        <p><i class="icon-chevron-right"></i> <a href="http://free.stella-mail.com/config/">変更する</a></p>
      </div>
      <div class="multicolumn">
        <h3><i class="icon-smile"></i> 読者数と記事数</h3>
        <p><span class="mobile-six">現在の読者数：<?php echo stella_countlist($_COOKIE['userid']); ?>件</span><span class="mobile-six"><span class="typebutton <?php $n = stella_holdertype($_COOKIE['userid']); echo $n['name']; ?>"><?php echo $n['desc']; ?>プラン</span></span></p>
        <p>現在の記事数：<?php echo stella_countholder($_COOKIE['userid']); ?>件</p>
        <p><i class="icon-chevron-right"></i> <a href="http://free.stella-mail.com/list/">配信リストを表示</a></p>
      </div>
      <div class="multicolumn">
